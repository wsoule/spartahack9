  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        WasteWell's mission is to make recycling easy and fun. We aim to educate
        and engage users in sustainable practices through a simple, interactive
        app that identifies recyclable items with just a photo. Join us in our
        journey to inspire a greener lifestyle, one piece of trash at a time.
      </Text>
